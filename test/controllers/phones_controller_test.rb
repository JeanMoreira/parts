...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { active: @phone.active, member_id: @phone.member_id, phone: @phone.phone } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { active: @phone.active, member_id: @phone.member_id, phone: @phone.phone } }
